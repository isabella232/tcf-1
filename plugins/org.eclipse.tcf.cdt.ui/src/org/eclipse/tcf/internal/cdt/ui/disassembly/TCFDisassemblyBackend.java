...
public class TCFDisassemblyBackend extends AbstractDisassemblyBackend {
    ...
    public void retrieveDisassembly(final BigInteger startAddress,
        ...
        Protocol.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                fCallback.asyncExec(new Runnable() {
                    public void run() {
                        insertDisassembly(request, startAddress, range, big_endian,
    ...
    protected final void insertDisassembly(Request request, BigInteger startAddress, AddressRange range, boolean big_endian,
